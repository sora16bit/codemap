...
Ouvrez <http://localhost:3000>, collez un dépôt (`owner/repo` ou une URL complète `github.com/...`) et cliquez sur **Analyser**. Essayez `sindresorhus/ky` ou `cli/cli` pour le voir sur une vraie base de code.
